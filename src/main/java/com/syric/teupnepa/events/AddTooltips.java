...
//        if (event.getItemStack().getItem() instanceof ModularItem && !UpgradedNetheriteConfig.DisableTooltips && Screen.hasShiftDown() && event.getEntity() != null) {
...
//    }
//
//    public boolean addBothLines(ItemTooltipEvent event, @NotNull ItemStack stack) {
