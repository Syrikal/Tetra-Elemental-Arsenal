...
public class TUNPItems {
    ...
    public static final RegistryObject<Item> FROST_UPGRADED_NETHERITE_INGOT = ITEMS.register("frost_upgraded_netherite_ingot", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> LIGHTNING_UPGRADED_NETHERITE_INGOT = ITEMS.register("lightning_upgraded_netherite_ingot", () -> new Item(new Item.Properties()));
    ...
    public static void buildCreativeModeTabs(BuildCreativeModeTabContentsEvent event) {
        if (event.getTabKey() == CreativeModeTabs.INGREDIENTS) {
            ...
            event.accept(FROST_UPGRADED_NETHERITE_INGOT);
            event.accept(LIGHTNING_UPGRADED_NETHERITE_INGOT);
