...
public class EATags {
    ...
    public static class EntityTypes {
        ...
        private static TagKey<EntityType<?>> tag(String name) {
            return TagKey.create(Registries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(ElementalArsenal.MODID, name));
        }
    }
    ...
    public static class MobEffects {
        ...
        private static TagKey<MobEffect> tag(String name) {
            return TagKey.create(Registries.MOB_EFFECT, ResourceLocation.fromNamespaceAndPath(ElementalArsenal.MODID, name));
        }
    }
